...
def test_set_net_per_module():
    ...
    assert set(L._net_params().keys()) == {"cortex", "hippocampus", "bg", "neuromod", "cerebellum", "endocrine", "dynamics", "peptides", "glia", "stdp", "stp", "plateau", "interneurons", "laminar", "ripple", "theta", "embodiment", "spatial"}
