...
def test_snapshot_shape():
    ...
    assert set(snap["netparams"]) == {"cortex", "hippocampus", "bg", "neuromod", "cerebellum", "endocrine", "dynamics", "peptides", "glia", "stdp", "stp", "plateau", "interneurons", "laminar", "ripple", "theta", "embodiment", "spatial"}
